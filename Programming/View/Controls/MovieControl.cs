...
namespace Programming.View.Controls
{
    ...
    public partial class MovieControl : UserControl
    {
        ...
        private void DurationMinutesMovieTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                DurationMinutesMovieTextBox.BackColor = ProgramColors.ErrorColor;
                return;
            }

            DurationMinutesMovieTextBox.BackColor = ProgramColors.CorrectColor;
        }
        ...
        private void YearReleaseMovieTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                YearReleaseMovieTextBox.BackColor = ProgramColors.ErrorColor;
                return;
            }

            YearReleaseMovieTextBox.BackColor = ProgramColors.CorrectColor;
        }
        ...
        private void RatingMovieTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                RatingMovieTextBox.BackColor = ProgramColors.ErrorColor;
                return;
            }

            RatingMovieTextBox.BackColor = ProgramColors.CorrectColor;
        }
