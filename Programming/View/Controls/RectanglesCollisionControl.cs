...
namespace Programming.View.Controls
{
    ...
    public partial class RectanglesCollisionControl : UserControl
    {
        ...
        private void FindCollisions()
        {
            ...
            {
                CanvasPanel.Controls[i].BackColor = ProgramColors.IsNotCollision;
            }
            ...
            for (int i = 0; i < _rectanglePanels.Count - 1; i++)
            {
                for (int j = i + 1; j < _rectangles.Count; j++)
                {
                    ...
                    {
                        CanvasPanel.Controls[i].BackColor = ProgramColors.IsCollision;
                        CanvasPanel.Controls[j].BackColor = ProgramColors.IsCollision;
                    }
                }
            }
        }
        ...
        private void AddRectangleButton_Click(object sender, EventArgs e)
        {
            ...
            rectanglePanel.BackColor = ProgramColors.IsNotCollision;
        ...
        private void XSelectedTextBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                XSelectedTextBox.BackColor = ProgramColors.CorrectColor;
            ...
            catch (Exception exception)
            {
                ...
                XSelectedTextBox.BackColor = ProgramColors.ErrorColor;
            }
        }
        ...
        private void YSelectedTextBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                YSelectedTextBox.BackColor = ProgramColors.CorrectColor;
            ...
            {
                Console.WriteLine(exception);
                YSelectedTextBox.BackColor = ProgramColors.ErrorColor;
            }
        }
        ...
        private void WidthSelectedTextBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                WidthSelectedTextBox.BackColor = ProgramColors.CorrectColor;
            ...
            catch (Exception exception)
            {
                ...
                WidthSelectedTextBox.BackColor = ProgramColors.ErrorColor;
            }
        }
        ...
        private void HeightSelectedTextBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                HeightSelectedTextBox.BackColor = ProgramColors.CorrectColor;
            ...
            {
                Console.WriteLine(exception);
                HeightSelectedTextBox.BackColor = ProgramColors.ErrorColor;
            }
        }
